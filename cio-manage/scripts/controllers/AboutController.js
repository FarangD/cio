angular.module('e-homework').controller('AboutController', function($scope, $compile, $cookies, $filter, $state, HTTPService, IndexOverlayFactory) {
    ...
    $scope.save = function(action, AboutObj, AttachFileObj){
        // console.log($scope.About);
        IndexOverlayFactory.overlayShow();
        AboutObj.contents = CKEDITOR.instances.editor1.getData();
        AboutObj.contents_en = CKEDITOR.instances.editor2.getData();

        var params = {'AboutObj':AboutObj, 'AttachFileObj':AttachFileObj};
